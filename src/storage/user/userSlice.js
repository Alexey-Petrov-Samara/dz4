...
export const userAuthanticate = createAsyncThunk(
  'user/userAuthanticate',
  async function (dataAuth, { rejectWithValue, fulfillWithValue, extra: api }) {
    try {
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(userAuthanticate.pending, (state) => {
        state.loginUserRequest = true;
        state.userError = null;
      })
      .addCase(userAuthanticate.fulfilled, (state, action) => {
